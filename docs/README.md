...
**Meth3D-Net V6: An Integrative Multi-Scale Epigenomic Framework for Methylation Prediction, Chromatin Instability Detection, and lncRNA–miRNA Regulatory Network Identification in Medulloblastoma**

---

## Overview

Meth3D-Net V6 is a computational epigenomics framework that integrates whole-genome bisulfite sequencing (WGBS), Illumina 450k methylation arrays, chromatin state annotations, and lncRNA expression data to characterise the multi-dimensional epigenetic landscape of medulloblastoma. The framework spans four analytical axes: genome-wide CpG methylation prediction, epigenetic clock-based age estimation, multi-axis tumour epigenetic scoring, and lncRNA–miRNA–mRNA ceRNA network construction.

Applied to 763 medulloblastoma tumours (GSE85212; Cavalli et al. 2017), Meth3D-Net V6 identifies epigenetic instability, oncogenic methylation imbalance, chromatin repression disruption, and regulatory lncRNA candidates as orthogonal but partially correlated axes of tumour biology.
...
> [Manuscript in preparation] Meth3D-Net V6: An Integrative Multi-Scale Epigenomic Framework for Methylation Prediction, Chromatin Instability Detection, and lncRNA–miRNA Regulatory Network Identification in Medulloblastoma.
